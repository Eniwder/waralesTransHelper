...
const xmlData = fs.readFileSync('playing/export_zh.xml', 'utf8').replace(/<br ?\/>/g, '&lt;br/&gt;');
...
fs.writeFileSync('intermediate/export_ja_kv.json', JSON.stringify(kvobj, null, 2), 'utf8');
